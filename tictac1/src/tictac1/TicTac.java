...
public class TicTac extends javax.swing.JFrame {
    ...
    private void gameScore()
       {
          jblHracX.setText(String.valueOf(xCount));
          jblHracO.setText(String.valueOf(oCount));
       } 
    ...
    private void winningGame()
        {
            ...
            if(b1 ==("X") && b2 ==("X") && b3 ==("X"))
            {
                JOptionPane.showMessageDialog(this,"Hráč X vyhrál","Tic Tac",JOptionPane.INFORMATION_MESSAGE);
                xCount++;
                gameScore();
            ...
            if(b1 ==("O") && b2 ==("O") && b3 ==("O"))
            {
                JOptionPane.showMessageDialog(this,"Hráč O vyhrál","Tic Tac",JOptionPane.INFORMATION_MESSAGE);
                oCount++;
                gameScore();
...
private JFrame frame;  
    ...
    private void initComponents() {
        ...
        jblHracX = new javax.swing.JLabel();
        ...
        jblHracO = new javax.swing.JLabel();
        ...
        jblHracX.setFont(new java.awt.Font("Tahoma", 2, 36)); // NOI18N
        jblHracX.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel7.add(jblHracX, java.awt.BorderLayout.CENTER);
        ...
        jblHracO.setFont(new java.awt.Font("Tahoma", 2, 36)); // NOI18N
        jblHracO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel13.add(jblHracO, java.awt.BorderLayout.CENTER);
        ...
        jbtnReset.setFont(new java.awt.Font("Tahoma", 2, 36)); // NOI18N
        ...
        jbtnExit.setFont(new java.awt.Font("Tahoma", 2, 36)); // NOI18N
        ...
        jPanel12.add(jbtnExit, java.awt.BorderLayout.CENTER);
    ...
    private void jbtnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnExitActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,"Potvrďte, zda chcete ukončit","Tic Tac",
    ...
    private javax.swing.JLabel jblHracO;
    private javax.swing.JLabel jblHracX;
